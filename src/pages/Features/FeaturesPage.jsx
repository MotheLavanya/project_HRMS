...
const FeaturesPage = ({ onDemoClick, onNavigate }) => {
    const [activeTab, setActiveTab] = useState(0);

    return (
        <div className="features-page-root">
            <section className="nexus-features-tabbed standalone" id="features">
                ...
                <div className="tabbed-container">
                    ...
                    {/* <div className="tabbed-footer-divider standalone-cta">
                        <div className="footer-divider-pill" onClick={onDemoClick} style={{ cursor: 'pointer' }}>
                            <span>Book a Demo to See All Features in Action <ArrowRight size={16} style={{ marginLeft: '8px' }} /></span>
                        </div>
                    </div> */}
                </div>
            </section>
